...
<style>
    ...
    <div class="container mt-5">
        ...
        <div class="table-responsive mt-3">
            ...
            <form class="d-flex" action="../Controlador/controladorPaciente.php" method="post">
                <button class="btn btn-outline-success" type="submit" name="Acciones" value="Inactivo">Pacientes Inactivos</button>
            </form>
            <hr>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    foreach ($_SESSION['resultadoP'] as $fila) {
                        ...
                        echo "<tr>";
                            ...
                            echo '<td>
                                    <form action="../Controlador/controladorPaciente.php" method="post">
                                        ...
                                        <button class="btn btn-danger" type="submit" name="Acciones" value="BorrarPaciente">Cambiar</button>
                                    </form>
                                </td>';
                        echo "</tr>";
                        ...
                        echo '<button class="btn btn-warning" type="submit" name="Acciones" value="ActualizarPaciente">Actualizar paciente</button>';
                        echo '</form>';
                                                echo '</div>';
                        echo '</div>';
                        echo '</div>';
        ...
        <div>
            ...
            <form action="../Controlador/controladorPaciente.php" method="post">
                ...
                <button class="btn btn-success" type="submit" name="Acciones" value="CrearPaciente">Crear paciente</button>
            </form>
        </div>
    </div>
    <br><br>
